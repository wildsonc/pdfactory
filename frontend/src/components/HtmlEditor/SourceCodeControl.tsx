...
const SourceCodeControl = () => {
  ...
  return (
    <>
      <RichTextEditor.Control onClick={handlers.open} aria-label="Source code" title="Source code">
        <IconSourceCode stroke={1.5} size={16} />
      </RichTextEditor.Control>
      <Modal title="Source code" size="80%" opened={opened} onClose={handlers.close}>
        <CustomEditor value={content} onChange={(e) => setContent(e)} language="jsx" />
